...
namespace TelegramBot.Migrations
{
    ...
    [Migration("20220908160011_add-mon-interval")]
    partial class addmoninterval
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelegramBot.Objects.UserConfig", b =>
                {
                    ...
                    b.Property<bool>("SetExchangeAutomaticaly")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("ShowMarketEvents")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("SubSetsId")
                        .HasColumnType("INTEGER");

                    b.Property<long>("TelegramId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("TimezoneChange")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("TriggerOneTasksByDefault")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TelegramBot.Objects.MessageAccepted", b =>
                {
                    b.HasOne("TelegramBot.Objects.UserConfig", "UserConfig")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("TelegramBot.Objects.UserConfig", b =>
                {
                    b.HasOne("TelegramBot.Objects.BreakoutSub", "SubSets")
                        .WithMany()
                        .HasForeignKey("SubSetsId");
